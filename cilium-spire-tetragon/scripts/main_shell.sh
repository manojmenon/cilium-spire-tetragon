...
echo " "
echo "******************************************************************************************************************"
echo "All components successully installed - check out pod health by running kubectl -n ${NAME_SPACE}   get pods -A. "
echo "If all pods are not in Running status, some tests will fail !! "
echo "Check out pod health by running kubectl -n ${NAME_SPACE}   get pods -A. "
echo "******************************************************************************************************************"

echo "  A.To watch network related events "
echo " "
echo " "
echo "  run 'cilium hubble ui' to see in browser"
echo " "
echo "  run 'hubble observe -n ${NAME_SPACE} -f ' to see it on terminal"
echo " "
...
echo "  To watch file related events "
